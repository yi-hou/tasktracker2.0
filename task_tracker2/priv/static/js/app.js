...
function update_time() {
	(0, _jquery2.default)('.time-block-button').each(function (_, bb) {
		var start = (0, _jquery2.default)(bb).data('start');
		console.log(start);
		if (start != true) {
...
function init_time() {
	...
	(0, _jquery2.default)(".time-block-button").click(time_click);
}

(0, _jquery2.default)(init_manage);
(0, _jquery2.default)(init_time);
